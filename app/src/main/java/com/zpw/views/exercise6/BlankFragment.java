...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (mPos){
            case 0:
                imageView.setImageResource(R.mipmap.pos0);
                break;
            case 1:
                imageView.setImageResource(R.mipmap.pos1);
                break;
            case 2:
                imageView.setImageResource(R.mipmap.pos2);
                break;
            default:
                imageView.setImageResource(R.mipmap.pos3);
                break;
        }
        return view;
    }
