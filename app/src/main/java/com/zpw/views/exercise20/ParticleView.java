package com.zpw.views.exercise20;
...
public class ParticleView extends View {
    ...
    private void initView(AttributeSet attrs) {
        mHostText = "github";
        mParticleText = ".com";
        mParticleTextSize = sp2px(14);
        int hostTextSize = DEFAULT_MIN_TEXT_SIZE;
        mBgColor = Color.parseColor("#2E2E2E");
        mParticleColor = Color.parseColor("#CEF4FD");
        mTextAnimTime = DEFAULT_TEXT_ANIM_TIME;
        mSpreadAnimTime = DEFAULT_SPREAD_ANIM_TIME;
        mHostTextAnimTime = DEFAULT_HOST_TEXT_ANIM_TIME;
