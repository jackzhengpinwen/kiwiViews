...
public class CircleToHeart extends View {
    ...
    public CircleToHeart(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void drawCoordinateSystem(Canvas canvas) {
        ...
        canvas.drawLine(0, -mCenterY, 0, mCenterY, mFuzhuPaint);
        canvas.drawLine(-mCenterX, 0, mCenterX, 0, mFuzhuPaint);
